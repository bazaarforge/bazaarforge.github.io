...
- **New filtering operators**: In addition to the existing operators such as "equal," "greater than," etc., we've added new operators—**"is empty"** and **"is not empty"** have been added for all **metafields** and the product field **"compare-at price"**, allowing filtering of blank data.
