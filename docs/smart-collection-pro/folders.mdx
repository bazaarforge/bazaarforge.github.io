...
This is useful when you want to organize your hierarchy at the top level without creating extra collections that show up in your storefront, in search results, or in Shopify's collection picker.

For example, say you have dozens of collections and want to group them by purpose to keep things manageable. You could create folders like Seasonal Rotations, Landing Pages, or Promotions to organize related collections together. A Promotions folder might contain your Black Friday Deals, Cyber Monday Picks, and End of Season Sale collections. The folders make your tree easier to navigate in the app, but they don't create extra pages on your storefront that you'd then need to manage.
...
For more details on the CSV format, see [CSV Import & Export](./csv-import-export.mdx).
