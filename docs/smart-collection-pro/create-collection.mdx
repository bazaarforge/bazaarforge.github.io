...
- Choose **Create a new collection** and enter a name for your new collection. This will create a new collection in your store.
![New collection screenshot](./img/create-collection/new-collection.png)

- Choose **Use an existing collection** – This will convert an existing collection into a Managed Collection.
...
![Existing collection screenshot](./img/create-collection/existing-collection.png)
