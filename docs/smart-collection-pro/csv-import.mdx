...
This feature has limited error coverage. If an import fails, it may do so silently or with a generic error message. If that happens, contact us with your CSV and we'll help diagnose what went wrong.
